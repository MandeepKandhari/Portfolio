		...
		<div id='contact'>
			...
			<div className='tc center-column'> 
				<div className='w-50 flex justify-around pa2 ma1'>
					<a href='https://www.facebook.com/profile.php?id=100000108468240'><FontAwesome name='facebook' className='icons grow mh1-l mh3 mv2 pa2' /> </a>
					<a href='https://www.linkedin.com/in/mandeep-kandhari-59b1bb112/'><FontAwesome name='linkedin' className='icons grow mh1-l mh3 mv2 pa2' /> </a>
					<a href='https://github.com/MandeepKandhari'><FontAwesome name='github' className='icons grow mh1-l mh3 mv2 pa2' /> </a>
				</div>
				...
				<div className='w-80 w-50-l flex flex-column items-center pa2 ma1 tc shadow-5 grow br4 pattern'>
					...
					<button className='pa3 ma3 br4 bg-black white bw2' type='submit'>Submit</button>
